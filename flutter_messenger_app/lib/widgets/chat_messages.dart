...
import 'package:flutter_messenger_app/widgets/message_bubble.dart';
        ...
        builder: (context, chatSnapshots) {
          ...
          return ListView.builder(
              ...
              itemBuilder: (context, index){
                  ...
                  if(nextUserIsSame){
                    return MessageBubble.next(message: chatMessage['text'], isMe: authenticatedUser!.uid == chatMessage['userId']);
                  }else {
